...
**Instance URL formats:** `https://mycompany.my.salesforce.com` (production), `https://mycompany--sandbox.sandbox.my.salesforce.com` (sandbox).

**SF CLI does NOT accept lightning domains.** If a user provides a lightning domain (e.g. `mycompany.lightning.force.com`), ask for the instance URL instead.
